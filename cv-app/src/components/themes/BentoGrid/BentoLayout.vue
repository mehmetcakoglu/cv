      ...
      <div ref="cards"
        ...
        <div class="relative z-10">
          ...
          <h2 class="text-5xl md:text-8xl font-black tracking-tighter uppercase leading-[0.8] mb-12 italic">
            Shift Your<br><span
              class="text-transparent webkit-text-stroke-1 text-stroke-white/[0.1] opacity-60 group-hover:opacity-100 group-hover:text-violet-400 group-hover:webkit-text-stroke-0 transition-all duration-700">Dimension</span>
          </h2>
